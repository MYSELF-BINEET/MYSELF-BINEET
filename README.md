...
<p align="left">
<a href="https://www.linkedin.com/in/bineet-pradhan-2382aa258/" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg" alt="https://www.linkedin.com/in/bineet-pradhan-2382aa258" height="30" width="40" /></a>
                            ...
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        ...
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="241.59333333333333 155"/>
                                    </svg>
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    <div class="value-wrapper">
                                        <div class="value">3338</div>
                                    </div>
                                </div>
                                <div class="text">Repositories have been deployed 3338 times</div>
                            </div>
                        </div>
                        <div class="achievement s largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="42.986666666666665 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    stargazer
                                    <div class="value-wrapper">
                                        <div class="value">1416</div>
                                    </div>
                                </div>
                                <div class="text">Starred 1416 repositories</div>
                            </div>
                        </div>
                        <div class="achievement s largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="17.949 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                            ...
                            <div class="info">
                                <div class="title">
                                    <span class="prefix">Master</span>
                                    maintainer
                                    <span class="gh">ranked 2.68k out of 51.6m repositories</span>
                                    <div class="value-wrapper">
                                        <div class="value">11737</div>
                                    </div>
                                </div>
                                <div class="text">Maintaining a repository with 11737 stars</div>
                            </div>
                        </div>
                        <div class="achievement s largeable-width-half">
                            <div class="icon">
                        ...
                        <div class="achievement b largeable-width-half">
                            <div class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" height="44" width="44">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="gauge info">
                                        <circle class="gauge-base" r="25" cx="28" cy="28"/>
                                        <circle class="gauge-arc" transform="rotate(-90 28 28)" r="25" cx="28" cy="28" stroke-dasharray="51.666666666666664 155"/>
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" mask="url(#mask)">
                                        <g stroke-linecap="round" stroke-width="2" fill="none" fill-rule="evenodd">
                                            <g stroke="#7D6CFF">
                            ...
                            <div class="info">
                                <div class="title">
                                    ...
                                    developer
                                    <span class="gh">ranked 1.51m out of 126m users</span>
                                    <div class="value-wrapper">
                                        <div class="value">30</div>
                                    </div>
                                </div>
                                <div class="text">Published 30 public repositories</div>
                            </div>
                        </div>
